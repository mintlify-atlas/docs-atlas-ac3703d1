---
title: "Authentication API — Login, Register & Logout"
sidebarTitle: "Auth"
...
Create a new super-admin account. This endpoint is typically used during initial platform setup and does not require an existing session.
...
<ParamField body="role" type="string">
  Role to assign to the user. Defaults to `super-admin` if omitted.
</ParamField>
