...
description: "Record attendance, manage the class agenda with file attachments, maintain a weighted grade book, log anecdotal observations, and publish school circulars."
---
...
<ResponseField name="periodo_evaluacion_id" type="integer">
  ID of the evaluation period this criterion belongs to.
</ResponseField>
...
<ResponseField name="periodo_evaluacion" type="object | null">
