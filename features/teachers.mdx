...
description: "Manage teaching staff, assign subjects, and configure weekly schedules for each professor in your school."
---
...
| `codigo` | `string` | Unique teacher code (`codigo_profesor`) |
| `especialidad` | `string?` | Optional specialty or subject area |
| `roles` | `string[]` | Always includes `"profesor"` |
...
| `/profesores/:id/materia` | `ProfesorAsignarMateriaScreen` | Assign a subject to the teacher |
| `/profesores/:id/horario` | `ProfesorHorarioScreen` | Add schedule slots for the teacher |
| `/profesores/:id/ver-horario` | `ProfesorVerHorarioScreen` | Read-only weekly timetable view |
| `/profesores/:id/materias-asignadas` | `ProfesorMateriasAsignadasScreen` | List of subjects currently assigned |
