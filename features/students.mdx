...
description: "Register students, manage their profiles, and enroll them in courses and sections for each academic period."
---
...
| `roles` | `string[]` | Always includes `"estudiante"` |
